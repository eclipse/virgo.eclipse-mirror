        ...
        if (webBeansContext.getManagedBeanConfigurator().isManagedBean(clazz)) {
            ...
            if(processInjectionTarget != null)
            {
                if(processInjectionTargetEvent != null)
                {
                    ...
                    final InjectionTarget updatedInjectionTarget = webBeansContext.getWebBeansUtil().fireProcessInjectionTargetEvent(processInjectionTarget).getInjectionTarget();
